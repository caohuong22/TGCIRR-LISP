...
Write-Host ''; Write-Host 'CAI DAT THANH CONG!' -ForegroundColor Green; Write-Host "Da cai vao: $targetBundle" -ForegroundColor Green; Write-Host 'Bay gio anh co the mo AutoCAD (ho tro AutoCAD 2021 - 2025+).' -ForegroundColor White; Write-Host ''
